...
import {
  ...
  validate2,
  validateObject
} from "./chunk-MGKFEQHM.js";
import {
  css,
  unsafeCSS
} from "./chunk-3KWHLRWH.js";
import {
  HashMD as HashMD2
} from "./chunk-YN6CWTAR.js";
import {
  LruMap,
  defineFormatter,
  hexToNumber,
  ...
  numberToHex
} from "./chunk-KXJ6VXDI.js";
import {
  rotl as rotl2,
  wrapConstructor
} from "./chunk-2I7LFKO3.js";
import {
  require_elliptic
} from "./chunk-7VWGPVKI.js";
import {
  require_events
} from "./chunk-RHYFEGUQ.js";
import {
  init_esm
} from "./chunk-WUNPOFJD.js";
import {
  init_sha256,
  sha256 as sha2562
} from "./chunk-XXLRWMFW.js";
import {
  Chi,
  HashMD,
  Maj,
  ...
  init_sha2,
  sha256
} from "./chunk-26YQ5DDQ.js";
import {
  init_sha3,
  keccak_256
} from "./chunk-J3K75QGL.js";
import {
  anumber,
  clean,
  concatBytes,
...
var require_dayjs_min = __commonJS({
  "node_modules/dayjs/dayjs.min.js"(exports, module) {
    var import_dist1990 = __toESM(require_dist());
    var import_dist1991 = __toESM(require_dist2());
    var import_dist1992 = __toESM(require_dist3());
    !function(t2, e3) {
...
function __importStar(mod2) {
  ...
  var result = {};
  if (mod2 != null) {
    for (var k4 in mod2) if (Object.hasOwnProperty.call(mod2, k4)) result[k4] = mod2[k4];
  }
  result.default = mod2;
  return result;
}
...
var import_dist1012, import_dist1013, import_dist1014, extendStatics2, __assign2;
var init_tslib_es62 = __esm({
  "node_modules/@walletconnect/environment/node_modules/tslib/tslib.es6.js"() {
    import_dist1012 = __toESM(require_dist());
    import_dist1013 = __toESM(require_dist2());
    import_dist1014 = __toESM(require_dist3());
...
function stringify3(x5, doExponential, isNonzero) {
...
P.sqrt = function() {
  ...
  s4 = Math.sqrt(+stringify3(x5, true, true));
  if (s4 === 0 || s4 === 1 / 0) {
    c7 = x5.c.join("");
...
P.toFixed = function(dp, rm) {
  ...
  return stringify3(x5, false, !!n5);
};
P[Symbol.for("nodejs.util.inspect.custom")] = P.toJSON = P.toString = function() {
  var x5 = this, Big2 = x5.constructor;
  return stringify3(x5, x5.e <= Big2.NE || x5.e >= Big2.PE, !!x5.c[0]);
};
P.toNumber = function() {
  var n5 = +stringify3(this, true, true);
...
P.toPrecision = function(sd, rm) {
  ...
  return stringify3(x5, sd <= x5.e || x5.e <= Big2.NE || x5.e >= Big2.PE, !!n5);
};
P.valueOf = function() {
  var x5 = this, Big2 = x5.constructor;
  if (Big2.strict === true) {
  ...
  return stringify3(x5, x5.e <= Big2.NE || x5.e >= Big2.PE, true);
};
var Big = _Big_();
var big_default = Big;
...
var import_dist1936 = __toESM(require_dist(), 1);
var import_dist1937 = __toESM(require_dist2(), 1);
var import_dist1938 = __toESM(require_dist3(), 1);
...
var import_dist1933 = __toESM(require_dist(), 1);
var import_dist1934 = __toESM(require_dist2(), 1);
var import_dist1935 = __toESM(require_dist3(), 1);
...
var BlockchainApiController = {
  ...
  async fetchSwapQuote({ amount, userAddress, from: from21, to: to3, gasPrice }) {
    var _a;
    const isSupported = await BlockchainApiController.isNetworkSupported((_a = ChainController.state.activeCaipNetwork) == null ? void 0 : _a.caipNetworkId);
    if (!isSupported) {
      return { quotes: [] };
  ...
  async generateSwapCalldata({ amount, from: from21, to: to3, userAddress, disableEstimate }) {
    var _a;
    const isSupported = await BlockchainApiController.isNetworkSupported((_a = ChainController.state.activeCaipNetwork) == null ? void 0 : _a.caipNetworkId);
    if (!isSupported) {
  ...
  async generateApproveCalldata({ from: from21, to: to3, userAddress }) {
    var _a;
    const { st: st2, sv } = BlockchainApiController.getSdkProperties();
    const isSupported = await BlockchainApiController.isNetworkSupported((_a = ChainController.state.activeCaipNetwork) == null ? void 0 : _a.caipNetworkId);
    if (!isSupported) {
...
// node_modules/@reown/appkit-controllers/node_modules/unstorage/dist/shared/unstorage.zVDD2mZo.mjs
...
var __spreadArray = function(to3, from21, pack) {
  if (pack || arguments.length === 2) for (var i5 = 0, l8 = from21.length, ar3; i5 < l8; i5++) {
    if (ar3 || !(i5 in from21)) {
      if (!ar3) ar3 = Array.prototype.slice.call(from21, 0, i5);
      ar3[i5] = from21[i5];
    }
  }
  return to3.concat(ar3 || Array.prototype.slice.call(from21));
};
var BrowserInfo = (
  /** @class */
  /* @__PURE__ */ function() {
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/index.js
var import_dist898 = __toESM(require_dist());
var import_dist899 = __toESM(require_dist2());
var import_dist900 = __toESM(require_dist3());

// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/getContract.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/getAction.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/createContractEventFilter.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/abi/encodeEventTopics.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/errors/log.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/filters/createFilterRequestScope.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/estimateContractGas.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/errors/getContractError.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/estimateGas.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/experimental/eip7702/utils/recoverAuthorizationAddress.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/recoverAddress.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/accounts/utils/publicKeyToAddress.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/recoverPublicKey.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/experimental/eip7702/utils/hashAuthorization.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/encoding/toRlp.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/errors/getEstimateGasError.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/errors/estimateGas.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/wallet/prepareTransactionRequest.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/estimateFeesPerGas.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/errors/fee.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/estimateMaxPriorityFeePerGas.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getBlock.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/errors/block.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getGasPrice.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/blob/blobsToCommitments.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/blob/blobsToProofs.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/blob/commitmentsToVersionedHashes.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/blob/commitmentToVersionedHash.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/hash/sha256.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/blob/toBlobSidecars.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/blob/toBlobs.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/errors/blob.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/constants/kzg.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/transaction/getTransactionType.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getChainId.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getBalance.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getContractEvents.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getLogs.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/abi/parseEventLogs.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/abi/decodeEventLog.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/readContract.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/simulateContract.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/watchContractEvent.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/observe.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/poll.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/wait.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getBlockNumber.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/promise/withCache.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getFilterChanges.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/uninstallFilter.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/wallet/writeContract.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/errors/account.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/chain/assertCurrentChain.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/errors/getTransactionError.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/wallet/sendRawTransaction.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getEip712Domain.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/errors/eip712.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/wallet/addChain.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/clients/createClient.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/uid.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/clients/transports/custom.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/clients/transports/createTransport.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/buildRequest.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/promise/withRetry.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/clients/transports/fallback.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/clients/transports/http.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/errors/transport.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/rpc/http.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/promise/withTimeout.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/clients/createPublicClient.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/clients/decorators/public.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/ens/getEnsAddress.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/ens/errors.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/ens/namehash.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/ens/encodedLabelToLabelhash.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/ens/packetToBytes.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/ens/encodeLabelhash.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/ens/labelhash.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/ens/getEnsAvatar.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/ens/avatar/parseAvatarRecord.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/ens/avatar/utils.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/errors/ens.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/ens/getEnsText.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/ens/getEnsName.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/ens/getEnsResolver.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/createAccessList.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/createBlockFilter.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/createEventFilter.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/createPendingTransactionFilter.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getBlobBaseFee.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getBlockTransactionCount.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getCode.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getFeeHistory.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/formatters/feeHistory.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getFilterLogs.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getProof.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/formatters/proof.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/index.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/chain/defineChain.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/chain/extractChain.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/rpc/compat.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/rpc/webSocket.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/rpc/socket.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/typedData.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/errors/typedData.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/hashTypedData.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/abi/decodeFunctionData.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/abi/encodeErrorResult.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/abi/encodeFunctionResult.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/abi/encodePacked.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/address/getContractAddress.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/data/isBytes.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/encoding/fromRlp.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/hash/toEventSignature.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/hash/toFunctionSignature.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/hash/toEventHash.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/hash/toFunctionHash.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/hash/isHash.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/hash/ripemd160.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/recoverMessageAddress.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/hashMessage.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/toPrefixedMessage.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/constants/strings.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/recoverTypedDataAddress.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/verifyHash.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/verifyMessage.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/verifyTypedData.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/parseErc6492Signature.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/isErc6492Signature.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/constants/bytes.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/serializeErc6492Signature.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/transaction/getSerializedTransactionType.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/transaction/assertTransaction.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/transaction/parseTransaction.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/transaction/serializeTransaction.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/experimental/eip7702/utils/serializeAuthorizationList.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/transaction/serializeAccessList.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/unit/parseUnits.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/errors/unit.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/unit/parseEther.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/unit/parseGwei.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getStorageAt.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getTransaction.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getTransactionConfirmations.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/getTransactionReceipt.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/multicall.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/simulateBlocks.js
...
// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/BlockOverrides.js
...
// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/Json.js
...
var IntegerOutOfRangeError2 = class extends BaseError4 {
...
// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/Withdrawal.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/simulateCalls.js
...
// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/AbiConstructor.js
var import_dist673 = __toESM(require_dist());
var import_dist674 = __toESM(require_dist2());
var import_dist675 = __toESM(require_dist3());

// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/AbiItem.js
...
function keccak2563(value, options = {}) {
  ...
  const bytes = keccak_2562(from3(value));
  if (as2 === "Bytes")
    return bytes;
  return fromBytes3(bytes);
}

// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/internal/abiItem.js
...
// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/PublicKey.js
...
// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/internal/abiParameters.js
...
// node_modules/@reown/appkit-controllers/node_modules/ox/_esm/core/AbiFunction.js
var import_dist676 = __toESM(require_dist());
var import_dist677 = __toESM(require_dist2());
var import_dist678 = __toESM(require_dist3());

// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/constants/address.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/verifyMessage.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/verifyHash.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/serializeSignature.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/verifyTypedData.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/waitForTransactionReceipt.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/watchBlockNumber.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/watchBlocks.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/watchEvent.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/public/watchPendingTransactions.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/siwe/verifySiweMessage.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/siwe/parseSiweMessage.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/siwe/validateSiweMessage.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/clients/createTestClient.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/clients/decorators/test.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/dropTransaction.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/dumpState.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/getAutomine.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/getTxpoolContent.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/getTxpoolStatus.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/impersonateAccount.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/increaseTime.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/inspectTxpool.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/loadState.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/mine.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/removeBlockTimestampInterval.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/reset.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/revert.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/sendUnsignedTransaction.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/setAutomine.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/setBalance.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/setBlockGasLimit.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/setBlockTimestampInterval.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/setCode.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/setCoinbase.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/setIntervalMining.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/setLoggingEnabled.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/setMinGasPrice.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/setNextBlockBaseFeePerGas.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/setNextBlockTimestamp.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/setNonce.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/setRpcUrl.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/setStorageAt.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/snapshot.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/test/stopImpersonatingAccount.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/clients/decorators/wallet.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/wallet/deployContract.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/wallet/getAddresses.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/wallet/getPermissions.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/wallet/requestAddresses.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/wallet/requestPermissions.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/wallet/signMessage.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/wallet/signTransaction.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/wallet/signTypedData.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/wallet/switchChain.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/actions/wallet/watchAsset.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/clients/createWalletClient.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/clients/transports/webSocket.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/types/eip1193.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/abi/decodeDeployData.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/compactSignatureToSignature.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/parseCompactSignature.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/parseSignature.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/recoverTransactionAddress.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/signatureToCompactSignature.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/signature/serializeCompactSignature.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/blob/sidecarsToVersionedHashes.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/blob/fromBlobs.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/kzg/defineKzg.js
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/utils/node_modules/viem/_esm/utils/kzg/setupKzg.js
...
// node_modules/uint8arrays/esm/src/concat.js
function concat5(arrays, length2) {
  if (!length2) {
...
var from8 = ({ name: name2, prefix, encode: encode11, decode: decode8 }) => new Codec(name2, prefix, encode11, decode8);
...
// node_modules/multiformats/esm/src/hashes/hasher.js
var from9 = ({ name: name2, code: code2, encode: encode11 }) => new Hasher(name2, code2, encode11);
var Hasher = class {
...
var import_dist1930 = __toESM(require_dist(), 1);
var import_dist1931 = __toESM(require_dist2(), 1);
var import_dist1932 = __toESM(require_dist3(), 1);

// node_modules/@reown/appkit-controllers/dist/esm/src/utils/SendApiUtil.js
var import_dist1927 = __toESM(require_dist(), 1);
var import_dist1928 = __toESM(require_dist2(), 1);
var import_dist1929 = __toESM(require_dist3(), 1);

// node_modules/@reown/appkit-controllers/dist/esm/src/utils/ERC7811Util.js
var import_dist1924 = __toESM(require_dist(), 1);
var import_dist1925 = __toESM(require_dist2(), 1);
var import_dist1926 = __toESM(require_dist3(), 1);
...
async function recoverPublicKey2({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k14 } = await import("./secp256k1-NVAIUXS6.js");
  const signature_ = (() => {
...
var EstimateGasExecutionError2 = class extends BaseError {
  constructor(cause, { account, docsPath, chain, data, gas, gasPrice, maxFeePerGas, maxPriorityFeePerGas, nonce, to: to3, value }) {
    var _a;
...
async function getBlock2(client, { blockHash, blockNumber, blockTag = client.experimental_blockTag ?? "latest", includeTransactions: includeTransactions_ } = {}) {
  ...
  const format = ((_c = (_b = (_a = client.chain) == null ? void 0 : _a.formatters) == null ? void 0 : _b.block) == null ? void 0 : _c.format) || formatBlock2;
...
function blobsToCommitments2(parameters) {
  ...
  return to3 === "bytes" ? commitments : commitments.map((x5) => bytesToHex(x5));
}
...
function blobsToProofs2(parameters) {
  ...
  return to3 === "bytes" ? proofs : proofs.map((x5) => bytesToHex(x5));
}
...
function toBlobs2(parameters) {
  ...
  return to3 === "bytes" ? blobs.map((x5) => x5.bytes) : blobs.map((x5) => bytesToHex(x5.bytes));
}

// node_modules/viem/_esm/utils/blob/toBlobSidecars.js
function toBlobSidecars2(parameters) {
  const { data, kzg, to: to3 } = parameters;
  const blobs = parameters.blobs ?? toBlobs2({ data, to: to3 });
  const commitments = parameters.commitments ?? blobsToCommitments2({ blobs, kzg, to: to3 });
  const proofs = parameters.proofs ?? blobsToProofs2({ blobs, commitments, kzg, to: to3 });
  const sidecars = [];
  for (let i5 = 0; i5 < blobs.length; i5++)
    sidecars.push({
      blob: blobs[i5],
...
async function fillTransaction(client, parameters) {
  var _a, _b, _c, _d, _e3;
  const { account = client.account, accessList, authorizationList, chain = client.chain, blobVersionedHashes, blobs, data, gas, gasPrice, maxFeePerBlobGas, maxFeePerGas, maxPriorityFeePerGas, nonce: nonce_, nonceManager: nonceManager3, to: to3, type, value, ...rest } = parameters;
  ...
  try {
    ...
    const format2 = ((_d = (_c = chain == null ? void 0 : chain.formatters) == null ? void 0 : _c.transaction) == null ? void 0 : _d.format) || formatTransaction2;
    ...
    if (feeMultiplier < 1)
      throw new BaseFeeScalarError2();
    const decimals = ((_e3 = feeMultiplier.toString().split(".")[1]) == null ? void 0 : _e3.length) ?? 0;
    const denominator = 10 ** decimals;
...
async function prepareTransactionRequest2(client, args) {
  ...
  request.parameters ?? (request.parameters = defaultParameters2);
  const { account: account_, chain = client.chain, nonceManager: nonceManager3, parameters } = request;
  ...
  if ((prepareTransactionRequest3 == null ? void 0 : prepareTransactionRequest3.fn) && ((_a = prepareTransactionRequest3.runAt) == null ? void 0 : _a.includes("beforeFillTransaction"))) {
    request = await prepareTransactionRequest3.fn({ ...request, chain }, {
  ...
  const fillResult = attemptFill ? await getAction2(client, fillTransaction, "fillTransaction")({ ...request, nonce }).then((result) => {
    const { chainId: chainId2, from: from21, gas: gas2, gasPrice, nonce: nonce2, maxFeePerBlobGas, maxFeePerGas, maxPriorityFeePerGas, type: type2, ...rest } = result.transaction;
    ...
    if (error.name !== "TransactionExecutionError")
      return request;
    const unsupported = (_a2 = error.walk) == null ? void 0 : _a2.call(error, (e4) => {
      const error2 = e4;
...
async function readContract2(client, parameters) {
  ...
  try {
    const { data } = await getAction2(client, call, "call")({
      ...rest,
      data: calldata,
      to: address
    });
...
async function sendTransaction2(client, parameters) {
  ...
  try {
    ...
    if ((account == null ? void 0 : account.type) === "local") {
      ...
      const serializer = (_e3 = chain == null ? void 0 : chain.serializers) == null ? void 0 : _e3.transaction;
...
var import_dist1705 = __toESM(require_dist(), 1);
var import_dist1706 = __toESM(require_dist2(), 1);
var import_dist1707 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/clients/decorators/public.js
var import_dist1702 = __toESM(require_dist(), 1);
var import_dist1703 = __toESM(require_dist2(), 1);
var import_dist1704 = __toESM(require_dist3(), 1);
...
var import_dist1618 = __toESM(require_dist(), 1);
var import_dist1619 = __toESM(require_dist2(), 1);
var import_dist1620 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/formatters/proof.js
var import_dist1615 = __toESM(require_dist(), 1);
var import_dist1616 = __toESM(require_dist2(), 1);
var import_dist1617 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/index.js
var import_dist1612 = __toESM(require_dist(), 1);
var import_dist1613 = __toESM(require_dist2(), 1);
var import_dist1614 = __toESM(require_dist3(), 1);
...
async function verifyAuthorization({ address, authorization, signature }) {
  return isAddressEqual(getAddress(address), await recoverAuthorizationAddress2({
    authorization,
    signature
  }));
}
...
var import_dist1564 = __toESM(require_dist(), 1);
var import_dist1565 = __toESM(require_dist2(), 1);
var import_dist1566 = __toESM(require_dist3(), 1);
...
var import_dist1558 = __toESM(require_dist(), 1);
var import_dist1559 = __toESM(require_dist2(), 1);
var import_dist1560 = __toESM(require_dist3(), 1);
...
function sha2567(value, options = {}) {
  const { as: as2 = typeof value === "string" ? "Hex" : "Bytes" } = options;
...
function fromHex4(publicKey) {
  ...
  if (publicKey.length === 130) {
    ...
    const y4 = BigInt(slice3(publicKey, 32, 64));
    return {
      prefix: 4,
      x: x6,
      y: y4
  ...
  if (publicKey.length === 132) {
    ...
    const y4 = BigInt(slice3(publicKey, 33, 65));
    return {
      prefix: prefix2,
      x: x6,
      y: y4
...
function toBytes3(publicKey, options = {}) {
  return fromHex(toHex4(publicKey, options));
}
...
function checksum4(address) {
  ...
  const hexAddress = address.substring(2).toLowerCase();
  const hash2 = keccak2564(fromString(hexAddress), { as: "Bytes" });
  const characters = hexAddress.split("");
  for (let i5 = 0; i5 < 40; i5 += 2) {
    if (hash2[i5 >> 1] >> 4 >= 8 && characters[i5]) {
      characters[i5] = characters[i5].toUpperCase();
...
function isEqual(addressA, addressB) {
  assert3(addressA, { strict: false });
  assert3(addressB, { strict: false });
...
function decodeBytes(cursor, param, { staticPosition }) {
  ...
  const value = fromBytes(cursor.readBytes(Number.parseInt(size8, 10), 32));
  return [value, 32];
}
...
function decodeTuple(cursor, param, options) {
  ...
  if (hasDynamicChild(param)) {
    ...
    for (let i5 = 0; i5 < param.components.length; ++i5) {
      ...
      consumed += consumed_;
      value[hasUnnamedChild ? i5 : component == null ? void 0 : component.name] = data;
    }
    cursor.setPosition(staticPosition + 32);
    return [value, 32];
  }
...
function encode8(preparedParameters) {
  let staticSize = 0;
...
function encodeArray(value, options) {
  ...
  if (dynamic || dynamicChild) {
    const data = encode8(preparedParameters);
    if (dynamic) {
...
function encodeTuple(value, options) {
  ...
  return {
    dynamic,
    encoded: dynamic ? encode8(preparedParameters) : concat2(...preparedParameters.map(({ encoded }) => encoded))
  };
}
...
function encode9(parameters, values, options) {
...
var ArrayLengthMismatchError2 = class extends BaseError2 {
...
var InvalidArrayError3 = class extends BaseError2 {
  constructor(value) {
...
var import_dist1549 = __toESM(require_dist(), 1);
var import_dist1550 = __toESM(require_dist2(), 1);
var import_dist1551 = __toESM(require_dist3(), 1);
...
function decodeRlpCursor(cursor, to3 = "Hex") {
  ...
  return readList(cursor, length2, to3);
}
...
function readList(cursor, length2, to3) {
...
function invert(number, modulo) {
  ...
  let b4 = modulo;
  let x5 = _0n, y4 = _1n, u3 = _1n, v5 = _0n;
  while (a3 !== _0n) {
    const q2 = b4 / a3;
    const r3 = b4 % a3;
    const m4 = x5 - u3 * q2;
    const n5 = y4 - v5 * q2;
    b4 = a3, a3 = r3, x5 = u3, y4 = v5, u3 = m4, v5 = n5;
  }
  const gcd = b4;
  if (gcd !== _1n)
...
function sqrt5mod8(Fp, n5) {
  ...
  const i5 = Fp.mul(Fp.mul(nv, _2n), v5);
...
function tonelliShanks(P6) {
  ...
  return function tonelliSlow(Fp, n5) {
    ...
    while (!Fp.eql(t2, Fp.ONE)) {
      ...
      const exponent = _1n << BigInt(M4 - i5 - 1);
...
function weierstrassPoints(opts) {
  ...
  function weierstrassEquation(x5) {
    ...
    return Fp.add(Fp.add(x32, Fp.mul(x5, a3)), b4);
  }
  ...
  function normPrivateKeyToScalar(key) {
    ...
    if (wrapPrivateKey)
      num2 = mod(num2, N10);
    aInRange("private key", num2, _1n3, N10);
    return num2;
  }
  ...
  class Point2 {
    ...
    static fromAffine(p4) {
      ...
      if (is0(x5) && is0(y4))
        return Point2.ZERO;
      return new Point2(x5, y4, Fp.ONE);
    }
    get x() {
      return this.toAffine().x;
    }
     ...
     */
    static fromHex(hex) {
      const P6 = Point2.fromAffine(fromBytes7(ensureBytes("pointHex", hex)));
      P6.assertValidity();
      return P6;
    }
    ...
    multiply(scalar) {
      const { endo: endo2, n: N10 } = CURVE;
      aInRange("scalar", scalar, _1n3, N10);
      let point, fake;
      if (endo2) {
    ...
    multiplyAndAddUnsafe(Q4, a3, b4) {
      ...
      const mul = (P6, a4) => a4 === _0n3 || a4 === _1n3 || !P6.equals(G3) ? P6.multiplyUnsafe(a4) : P6.multiply(a4);
...
function weierstrass(curveDef) {
  ...
  const { ProjectivePoint: Point2, normPrivateKeyToScalar, weierstrassEquation, isWithinCurveOrder } = weierstrassPoints({
    ...
    toBytes(_c, point, isCompressed) {
      const a3 = point.toAffine();
      const x5 = Fp.toBytes(a3.x);
      const cat = concatBytes2;
      abool("isCompressed", isCompressed);
      if (isCompressed) {
        return cat(Uint8Array.from([point.hasEvenY() ? 2 : 3]), x5);
      } else {
        return cat(Uint8Array.from([4]), x5, Fp.toBytes(a3.y));
      }
    },
    fromBytes(bytes) {
  ...
  const slcNum = (b4, from21, to3) => bytesToNumberBE(b4.slice(from21, to3));
  class Signature {
    constructor(r3, s4, recovery) {
      aInRange("r", r3, _1n3, CURVE_ORDER);
      aInRange("s", s4, _1n3, CURVE_ORDER);
      this.r = r3;
      this.s = s4;
      if (recovery != null)
  ...
  function prepSig(msgHash, privateKey, opts = defaultSigOpts) {
    ...
    function k2sig(kBytes) {
      ...
      if (!isWithinCurveOrder(k4))
        return;
      const ik = invN(k4);
      const q2 = Point2.BASE.multiply(k4).toAffine();
      const r3 = modN2(q2.x);
      if (r3 === _0n3)
        return;
      ...
      if (s4 === _0n3)
        return;
      let recovery = (q2.x === r3 ? 0 : 2) | Number(q2.y & _1n3);
      let normS = s4;
  ...
  function verify2(signature, msgHash, publicKey, opts = defaultVerOpts) {
    ...
    const R2 = (_a = Point2.BASE.multiplyAndAddUnsafe(P6, u1, u22)) == null ? void 0 : _a.toAffine();
    if (!R2)
      return false;
    const v5 = modN2(R2.x);
    return v5 === r3;
...
function SWUFpSqrtRatio(Fp, Z2) {
  const q2 = Fp.ORDER;
  let l8 = _0n3;
  for (let o5 = q2 - _1n3; o5 % _2n2 === _0n3; o5 /= _2n2)
    l8 += _1n3;
  const c1 = l8;
  const _2n_pow_c1_1 = _2n2 << c1 - _1n3 - _1n3;
  const _2n_pow_c1 = _2n_pow_c1_1 * _2n2;
  const c22 = (q2 - _1n3) / _2n_pow_c1;
  const c32 = (c22 - _1n3) / _2n2;
  const c42 = _2n_pow_c1 - _1n3;
  const c52 = _2n_pow_c1_1;
  const c62 = Fp.pow(Z2, c22);
  const c7 = Fp.pow(Z2, (c22 + _1n3) / _2n2);
  let sqrtRatio = (u3, v5) => {
    let tv1 = c62;
...
function mapToCurveSimpleSWU(Fp, opts) {
  ...
  return (u3) => {
    ...
    y4 = Fp.mul(tv1, u3);
    y4 = Fp.mul(y4, value);
    x5 = Fp.cmov(x5, tv3, isValid);
    y4 = Fp.cmov(y4, value, isValid);
    const e1 = Fp.isOdd(u3) === Fp.isOdd(y4);
    y4 = Fp.cmov(Fp.neg(y4), y4, e1);
    const tv4_inv = FpInvertBatch(Fp, [tv4], true)[0];
    x5 = Fp.mul(x5, tv4_inv);
    return { x: x5, y: y4 };
  };
}
...
function hash_to_field(msg, count, options) {
  ...
  const { p: p4, k: k4, m: m4, hash: hash2, expand, DST: _DST } = options;
  abytes(msg);
  anum(count);
  ...
  for (let i5 = 0; i5 < count; i5++) {
    ...
    for (let j3 = 0; j3 < m4; j3++) {
      const elm_offset = L3 * (j3 + i5 * m4);
      const tv = prb.subarray(elm_offset, elm_offset + L3);
      e3[j3] = mod(os2ip(tv), p4);
    }
    u3[i5] = e3;
  }
  return u3;
...
function isogenyMap(field, map) {
  ...
  return (x5, y4) => {
    const [xn2, xd, yn3, yd] = coeff.map((val) => val.reduce((acc, i5) => field.add(field.mul(acc, x5), i5)));
    const [xd_inv, yd_inv] = FpInvertBatch(field, [xd, yd], true);
    x5 = field.mul(xn2, xd_inv);
...
var secp256k13 = createCurve({
  ...
  endo: {
    ...
    splitScalar: (k4) => {
      ...
      const c1 = divNearest(b22 * k4, n5);
      const c22 = divNearest(-b1 * k4, n5);
      let k1 = mod(k4 - c1 * a1 - c22 * a22, n5);
...
function lift_x(x5) {
  aInRange("x", x5, _1n4, secp256k1P);
  const xx = modP(x5 * x5);
  const c7 = modP(xx * x5 + BigInt(7));
  let y4 = sqrtMod(c7);
  if (y4 % _2n3 !== _0n4)
    y4 = modP(-y4);
  const p4 = new Point(x5, y4, _1n4);
  p4.assertValidity();
  return p4;
}
...
function schnorrSign(message, privateKey, auxRand = randomBytes(32)) {
  ...
  sig.set(rx, 0);
  sig.set(numTo32b(modN(k4 + e3 * d5)), 32);
...
function schnorrVerify(signature, message, publicKey) {
  ...
  try {
    ...
    if (!inRange(r3, _1n4, secp256k1P))
      return false;
    const s4 = num(sig.subarray(32, 64));
    if (!inRange(s4, _1n4, secp256k1N))
      return false;
...
].map((i5) => i5.map((j3) => BigInt(j3)))))();
var mapSWU = (() => mapToCurveSimpleSWU(Fpk1, {
  A: BigInt("0x3f8731abdd661adca08a5558f0f5d272e953d363cb6f0e5d405447c01a444533"),
  B: BigInt("1771"),
  Z: Fpk1.create(BigInt("-11"))
}))();
var secp256k1_hasher = (() => createHasher2(secp256k13.ProjectivePoint, (scalars) => {
...
function fromTuple(tuple) {
  const [yParity, r3, s4] = tuple;
  return from14({
    r: r3 === "0x" ? 0n : BigInt(r3),
    s: s4 === "0x" ? 0n : BigInt(s4),
...
function toRpc3(signature) {
  const { r: r3, s: s4, yParity } = signature;
  return {
    r: fromNumber(r3, { size: 32 }),
    s: fromNumber(s4, { size: 32 }),
...
var import_dist1555 = __toESM(require_dist(), 1);
var import_dist1556 = __toESM(require_dist2(), 1);
var import_dist1557 = __toESM(require_dist3(), 1);

// node_modules/ox/_esm/core/internal/entropy.js
var import_dist1552 = __toESM(require_dist(), 1);
var import_dist1553 = __toESM(require_dist2(), 1);
var import_dist1554 = __toESM(require_dist3(), 1);
...
function recoverPublicKey3(options) {
  ...
  const { r: r3, s: s4, yParity } = signature;
  const signature_ = new secp256k13.Signature(BigInt(r3), BigInt(s4)).addRecoveryBit(yParity);
...
function verify(options) {
  ...
  if (address)
    return isEqual(address, recoverAddress3({ payload, signature }));
  return secp256k13.verify(signature, from(payload), toBytes3(publicKey), ...hash2 ? [{ prehash: true, lowS: true }] : []);
}
...
function unwrap(wrapped) {
  ...
  const [auth, to3, data] = decode7(suffixParameters, suffix);
...
function wrap(value) {
  ...
  const suffix = encode9(suffixParameters, [
    {
      ...value.authorization,
...
var import_dist1567 = __toESM(require_dist(), 1);
var import_dist1568 = __toESM(require_dist2(), 1);
var import_dist1569 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/signature/parseErc8010Signature.js
var import_dist1570 = __toESM(require_dist(), 1);
var import_dist1571 = __toESM(require_dist2(), 1);
var import_dist1572 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/signature/recoverMessageAddress.js
var import_dist1573 = __toESM(require_dist(), 1);
var import_dist1574 = __toESM(require_dist2(), 1);
var import_dist1575 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/signature/recoverTypedDataAddress.js
var import_dist1576 = __toESM(require_dist(), 1);
var import_dist1577 = __toESM(require_dist2(), 1);
var import_dist1578 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/signature/serializeErc6492Signature.js
var import_dist1579 = __toESM(require_dist(), 1);
var import_dist1580 = __toESM(require_dist2(), 1);
var import_dist1581 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/signature/serializeErc8010Signature.js
var import_dist1582 = __toESM(require_dist(), 1);
var import_dist1583 = __toESM(require_dist2(), 1);
var import_dist1584 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/signature/verifyHash.js
var import_dist1585 = __toESM(require_dist(), 1);
var import_dist1586 = __toESM(require_dist2(), 1);
var import_dist1587 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/signature/verifyMessage.js
var import_dist1588 = __toESM(require_dist(), 1);
var import_dist1589 = __toESM(require_dist2(), 1);
var import_dist1590 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/signature/verifyTypedData.js
var import_dist1591 = __toESM(require_dist(), 1);
var import_dist1592 = __toESM(require_dist2(), 1);
var import_dist1593 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/transaction/getSerializedTransactionType.js
var import_dist1594 = __toESM(require_dist(), 1);
var import_dist1595 = __toESM(require_dist2(), 1);
var import_dist1596 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/transaction/parseTransaction.js
var import_dist1597 = __toESM(require_dist(), 1);
var import_dist1598 = __toESM(require_dist2(), 1);
var import_dist1599 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/unit/parseEther.js
var import_dist1606 = __toESM(require_dist(), 1);
var import_dist1607 = __toESM(require_dist2(), 1);
var import_dist1608 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/unit/parseUnits.js
var import_dist1603 = __toESM(require_dist(), 1);
var import_dist1604 = __toESM(require_dist2(), 1);
var import_dist1605 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/errors/unit.js
var import_dist1600 = __toESM(require_dist(), 1);
var import_dist1601 = __toESM(require_dist2(), 1);
var import_dist1602 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/unit/parseGwei.js
var import_dist1609 = __toESM(require_dist(), 1);
var import_dist1610 = __toESM(require_dist2(), 1);
var import_dist1611 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/public/getStorageAt.js
var import_dist1621 = __toESM(require_dist(), 1);
var import_dist1622 = __toESM(require_dist2(), 1);
var import_dist1623 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/public/getTransaction.js
var import_dist1624 = __toESM(require_dist(), 1);
var import_dist1625 = __toESM(require_dist2(), 1);
var import_dist1626 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/public/getTransactionConfirmations.js
var import_dist1627 = __toESM(require_dist(), 1);
var import_dist1628 = __toESM(require_dist2(), 1);
var import_dist1629 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/public/getTransactionReceipt.js
var import_dist1630 = __toESM(require_dist(), 1);
var import_dist1631 = __toESM(require_dist2(), 1);
var import_dist1632 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/public/multicall.js
var import_dist1633 = __toESM(require_dist(), 1);
var import_dist1634 = __toESM(require_dist2(), 1);
var import_dist1635 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/public/simulateBlocks.js
var import_dist1636 = __toESM(require_dist(), 1);
var import_dist1637 = __toESM(require_dist2(), 1);
var import_dist1638 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/public/simulateCalls.js
var import_dist1654 = __toESM(require_dist(), 1);
var import_dist1655 = __toESM(require_dist2(), 1);
var import_dist1656 = __toESM(require_dist3(), 1);
...
var import_dist1642 = __toESM(require_dist(), 1);
var import_dist1643 = __toESM(require_dist2(), 1);
var import_dist1644 = __toESM(require_dist3(), 1);

// node_modules/ox/_esm/core/internal/abiItem.js
var import_dist1639 = __toESM(require_dist(), 1);
var import_dist1640 = __toESM(require_dist2(), 1);
var import_dist1641 = __toESM(require_dist3(), 1);
...
var import_dist1651 = __toESM(require_dist(), 1);
var import_dist1652 = __toESM(require_dist2(), 1);
var import_dist1653 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/public/verifyHash.js
var import_dist1666 = __toESM(require_dist(), 1);
var import_dist1667 = __toESM(require_dist2(), 1);
var import_dist1668 = __toESM(require_dist3(), 1);
...
var import_dist1657 = __toESM(require_dist(), 1);
var import_dist1658 = __toESM(require_dist2(), 1);
var import_dist1659 = __toESM(require_dist3(), 1);
...
function unwrap2(wrapped) {
  assert6(wrapped);
  const [to3, data, signature] = decode7(from12("address, bytes, bytes"), wrapped);
  return { data, signature, to: to3 };
}
function wrap2(value) {
  const { data, signature, to: to3 } = value;
  return concat2(encode9(from12("address, bytes, bytes"), [
    to3,
    data,
    signature
  ]), magicBytes2);
}
function validate9(wrapped) {
  try {
    assert6(wrapped);
    return true;
  } catch {
...
var import_dist1663 = __toESM(require_dist(), 1);
var import_dist1664 = __toESM(require_dist2(), 1);
var import_dist1665 = __toESM(require_dist3(), 1);
function serializeSignature2({ r: r3, s: s4, to: to3 = "hex", v: v5, yParity }) {
  const yParity_ = (() => {
    if (yParity === 0 || yParity === 1)
      return yParity;
    if (v5 && (v5 === 27n || v5 === 28n || v5 >= 35n))
      return v5 % 2n === 0n ? 1 : 0;
    throw new Error("Invalid `v` or `yParity` value");
  })();
  const signature = `0x${new secp256k1.Signature(hexToBigInt(r3), hexToBigInt(s4)).toCompactHex()}${yParity_ === 0 ? "1b" : "1c"}`;
  if (to3 === "hex")
    return signature;
...
// node_modules/viem/_esm/actions/public/verifyHash.js
async function verifyHash4(client, parameters) {
  var _a, _b, _c, _d;
  ...
  try {
    ...
    try {
      const verified = isAddressEqual(getAddress(address), await recoverAddress2({ hash: hash2, signature }));
      if (verified)
        return true;
    } catch {
    }
...
async function verifyErc8010(client, parameters) {
  ...
  const { authorization: authorization_ox, data: initData, signature, to: to3 } = SignatureErc8010_exports.unwrap(parameters.signature);
  const code2 = await getCode2(client, {
    address,
    blockNumber,
    blockTag
  });
  if (code2 === concatHex(["0xef0100", authorization_ox.address]))
  ...
  const authorization = {
    ...
    r: numberToHex2(authorization_ox.r, { size: 32 }),
    s: numberToHex2(authorization_ox.s, { size: 32 }),
  ...
  const results = await getAction2(client, readContract2, "readContract")({
...
async function verifyErc6492(client, parameters) {
  ...
  const { data } = await getAction2(client, call, "call")(args).catch((error) => {
...
async function verifyErc1271(client, parameters) {
  ...
  const result = await getAction2(client, readContract2, "readContract")({
    address,
    abi: erc1271Abi,
    args: [hash2, signature],
    blockNumber,
...
var import_dist1669 = __toESM(require_dist(), 1);
var import_dist1670 = __toESM(require_dist2(), 1);
var import_dist1671 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/public/verifyTypedData.js
var import_dist1672 = __toESM(require_dist(), 1);
var import_dist1673 = __toESM(require_dist2(), 1);
var import_dist1674 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/public/waitForTransactionReceipt.js
var import_dist1678 = __toESM(require_dist(), 1);
var import_dist1679 = __toESM(require_dist2(), 1);
var import_dist1680 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/public/watchBlockNumber.js
var import_dist1675 = __toESM(require_dist(), 1);
var import_dist1676 = __toESM(require_dist2(), 1);
var import_dist1677 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/public/watchBlocks.js
var import_dist1681 = __toESM(require_dist(), 1);
var import_dist1682 = __toESM(require_dist2(), 1);
var import_dist1683 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/public/watchEvent.js
var import_dist1684 = __toESM(require_dist(), 1);
var import_dist1685 = __toESM(require_dist2(), 1);
var import_dist1686 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/public/watchPendingTransactions.js
var import_dist1687 = __toESM(require_dist(), 1);
var import_dist1688 = __toESM(require_dist2(), 1);
var import_dist1689 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/siwe/verifySiweMessage.js
var import_dist1696 = __toESM(require_dist(), 1);
var import_dist1697 = __toESM(require_dist2(), 1);
var import_dist1698 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/siwe/parseSiweMessage.js
var import_dist1690 = __toESM(require_dist(), 1);
var import_dist1691 = __toESM(require_dist2(), 1);
var import_dist1692 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/siwe/validateSiweMessage.js
var import_dist1693 = __toESM(require_dist(), 1);
var import_dist1694 = __toESM(require_dist2(), 1);
var import_dist1695 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/sendRawTransactionSync.js
var import_dist1699 = __toESM(require_dist(), 1);
var import_dist1700 = __toESM(require_dist2(), 1);
var import_dist1701 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/clients/createTestClient.js
var import_dist1801 = __toESM(require_dist(), 1);
var import_dist1802 = __toESM(require_dist2(), 1);
var import_dist1803 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/clients/decorators/test.js
var import_dist1798 = __toESM(require_dist(), 1);
var import_dist1799 = __toESM(require_dist2(), 1);
var import_dist1800 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/dropTransaction.js
var import_dist1708 = __toESM(require_dist(), 1);
var import_dist1709 = __toESM(require_dist2(), 1);
var import_dist1710 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/dumpState.js
var import_dist1711 = __toESM(require_dist(), 1);
var import_dist1712 = __toESM(require_dist2(), 1);
var import_dist1713 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/getAutomine.js
var import_dist1714 = __toESM(require_dist(), 1);
var import_dist1715 = __toESM(require_dist2(), 1);
var import_dist1716 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/getTxpoolContent.js
var import_dist1717 = __toESM(require_dist(), 1);
var import_dist1718 = __toESM(require_dist2(), 1);
var import_dist1719 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/getTxpoolStatus.js
var import_dist1720 = __toESM(require_dist(), 1);
var import_dist1721 = __toESM(require_dist2(), 1);
var import_dist1722 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/impersonateAccount.js
var import_dist1723 = __toESM(require_dist(), 1);
var import_dist1724 = __toESM(require_dist2(), 1);
var import_dist1725 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/increaseTime.js
var import_dist1726 = __toESM(require_dist(), 1);
var import_dist1727 = __toESM(require_dist2(), 1);
var import_dist1728 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/inspectTxpool.js
var import_dist1729 = __toESM(require_dist(), 1);
var import_dist1730 = __toESM(require_dist2(), 1);
var import_dist1731 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/loadState.js
var import_dist1732 = __toESM(require_dist(), 1);
var import_dist1733 = __toESM(require_dist2(), 1);
var import_dist1734 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/mine.js
var import_dist1735 = __toESM(require_dist(), 1);
var import_dist1736 = __toESM(require_dist2(), 1);
var import_dist1737 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/removeBlockTimestampInterval.js
var import_dist1738 = __toESM(require_dist(), 1);
var import_dist1739 = __toESM(require_dist2(), 1);
var import_dist1740 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/reset.js
var import_dist1741 = __toESM(require_dist(), 1);
var import_dist1742 = __toESM(require_dist2(), 1);
var import_dist1743 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/revert.js
var import_dist1744 = __toESM(require_dist(), 1);
var import_dist1745 = __toESM(require_dist2(), 1);
var import_dist1746 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/sendUnsignedTransaction.js
var import_dist1747 = __toESM(require_dist(), 1);
var import_dist1748 = __toESM(require_dist2(), 1);
var import_dist1749 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/setAutomine.js
var import_dist1750 = __toESM(require_dist(), 1);
var import_dist1751 = __toESM(require_dist2(), 1);
var import_dist1752 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/setBalance.js
var import_dist1753 = __toESM(require_dist(), 1);
var import_dist1754 = __toESM(require_dist2(), 1);
var import_dist1755 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/setBlockGasLimit.js
var import_dist1756 = __toESM(require_dist(), 1);
var import_dist1757 = __toESM(require_dist2(), 1);
var import_dist1758 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/setBlockTimestampInterval.js
var import_dist1759 = __toESM(require_dist(), 1);
var import_dist1760 = __toESM(require_dist2(), 1);
var import_dist1761 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/setCode.js
var import_dist1762 = __toESM(require_dist(), 1);
var import_dist1763 = __toESM(require_dist2(), 1);
var import_dist1764 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/setCoinbase.js
var import_dist1765 = __toESM(require_dist(), 1);
var import_dist1766 = __toESM(require_dist2(), 1);
var import_dist1767 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/setIntervalMining.js
var import_dist1768 = __toESM(require_dist(), 1);
var import_dist1769 = __toESM(require_dist2(), 1);
var import_dist1770 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/setLoggingEnabled.js
var import_dist1771 = __toESM(require_dist(), 1);
var import_dist1772 = __toESM(require_dist2(), 1);
var import_dist1773 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/setMinGasPrice.js
var import_dist1774 = __toESM(require_dist(), 1);
var import_dist1775 = __toESM(require_dist2(), 1);
var import_dist1776 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/setNextBlockBaseFeePerGas.js
var import_dist1777 = __toESM(require_dist(), 1);
var import_dist1778 = __toESM(require_dist2(), 1);
var import_dist1779 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/setNextBlockTimestamp.js
var import_dist1780 = __toESM(require_dist(), 1);
var import_dist1781 = __toESM(require_dist2(), 1);
var import_dist1782 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/setNonce.js
var import_dist1783 = __toESM(require_dist(), 1);
var import_dist1784 = __toESM(require_dist2(), 1);
var import_dist1785 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/setRpcUrl.js
var import_dist1786 = __toESM(require_dist(), 1);
var import_dist1787 = __toESM(require_dist2(), 1);
var import_dist1788 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/setStorageAt.js
var import_dist1789 = __toESM(require_dist(), 1);
var import_dist1790 = __toESM(require_dist2(), 1);
var import_dist1791 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/snapshot.js
var import_dist1792 = __toESM(require_dist(), 1);
var import_dist1793 = __toESM(require_dist2(), 1);
var import_dist1794 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/test/stopImpersonatingAccount.js
var import_dist1795 = __toESM(require_dist(), 1);
var import_dist1796 = __toESM(require_dist2(), 1);
var import_dist1797 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/clients/createWalletClient.js
var import_dist1861 = __toESM(require_dist(), 1);
var import_dist1862 = __toESM(require_dist2(), 1);
var import_dist1863 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/clients/decorators/wallet.js
var import_dist1858 = __toESM(require_dist(), 1);
var import_dist1859 = __toESM(require_dist2(), 1);
var import_dist1860 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/addChain.js
var import_dist1804 = __toESM(require_dist(), 1);
var import_dist1805 = __toESM(require_dist2(), 1);
var import_dist1806 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/deployContract.js
var import_dist1807 = __toESM(require_dist(), 1);
var import_dist1808 = __toESM(require_dist2(), 1);
var import_dist1809 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/getAddresses.js
var import_dist1810 = __toESM(require_dist(), 1);
var import_dist1811 = __toESM(require_dist2(), 1);
var import_dist1812 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/getCapabilities.js
var import_dist1813 = __toESM(require_dist(), 1);
var import_dist1814 = __toESM(require_dist2(), 1);
var import_dist1815 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/getPermissions.js
var import_dist1816 = __toESM(require_dist(), 1);
var import_dist1817 = __toESM(require_dist2(), 1);
var import_dist1818 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/prepareAuthorization.js
var import_dist1819 = __toESM(require_dist(), 1);
var import_dist1820 = __toESM(require_dist2(), 1);
var import_dist1821 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/requestAddresses.js
var import_dist1822 = __toESM(require_dist(), 1);
var import_dist1823 = __toESM(require_dist2(), 1);
var import_dist1824 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/requestPermissions.js
var import_dist1825 = __toESM(require_dist(), 1);
var import_dist1826 = __toESM(require_dist2(), 1);
var import_dist1827 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/sendCallsSync.js
var import_dist1828 = __toESM(require_dist(), 1);
var import_dist1829 = __toESM(require_dist2(), 1);
var import_dist1830 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/sendTransactionSync.js
var import_dist1831 = __toESM(require_dist(), 1);
var import_dist1832 = __toESM(require_dist2(), 1);
var import_dist1833 = __toESM(require_dist3(), 1);
var supportsWalletNamespace3 = new LruMap2(128);

// node_modules/viem/_esm/actions/wallet/showCallsStatus.js
var import_dist1834 = __toESM(require_dist(), 1);
var import_dist1835 = __toESM(require_dist2(), 1);
var import_dist1836 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/signAuthorization.js
var import_dist1837 = __toESM(require_dist(), 1);
var import_dist1838 = __toESM(require_dist2(), 1);
var import_dist1839 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/signMessage.js
var import_dist1840 = __toESM(require_dist(), 1);
var import_dist1841 = __toESM(require_dist2(), 1);
var import_dist1842 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/signTransaction.js
var import_dist1843 = __toESM(require_dist(), 1);
var import_dist1844 = __toESM(require_dist2(), 1);
var import_dist1845 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/signTypedData.js
var import_dist1846 = __toESM(require_dist(), 1);
var import_dist1847 = __toESM(require_dist2(), 1);
var import_dist1848 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/switchChain.js
var import_dist1849 = __toESM(require_dist(), 1);
var import_dist1850 = __toESM(require_dist2(), 1);
var import_dist1851 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/watchAsset.js
var import_dist1852 = __toESM(require_dist(), 1);
var import_dist1853 = __toESM(require_dist2(), 1);
var import_dist1854 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/actions/wallet/writeContractSync.js
var import_dist1855 = __toESM(require_dist(), 1);
var import_dist1856 = __toESM(require_dist2(), 1);
var import_dist1857 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/clients/transports/createTransport.js
var import_dist1864 = __toESM(require_dist(), 1);
var import_dist1865 = __toESM(require_dist2(), 1);
var import_dist1866 = __toESM(require_dist3(), 1);
...
var import_dist1867 = __toESM(require_dist(), 1);
var import_dist1868 = __toESM(require_dist2(), 1);
var import_dist1869 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/clients/transports/fallback.js
var import_dist1870 = __toESM(require_dist(), 1);
var import_dist1871 = __toESM(require_dist2(), 1);
var import_dist1872 = __toESM(require_dist3(), 1);
...
var import_dist1876 = __toESM(require_dist(), 1);
var import_dist1877 = __toESM(require_dist2(), 1);
var import_dist1878 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/errors/transport.js
var import_dist1873 = __toESM(require_dist(), 1);
var import_dist1874 = __toESM(require_dist2(), 1);
var import_dist1875 = __toESM(require_dist3(), 1);
...
var import_dist1879 = __toESM(require_dist(), 1);
var import_dist1880 = __toESM(require_dist2(), 1);
var import_dist1881 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/types/eip1193.js
var import_dist1882 = __toESM(require_dist(), 1);
var import_dist1883 = __toESM(require_dist2(), 1);
var import_dist1884 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/abi/decodeDeployData.js
var import_dist1885 = __toESM(require_dist(), 1);
var import_dist1886 = __toESM(require_dist2(), 1);
var import_dist1887 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/blob/fromBlobs.js
var import_dist1888 = __toESM(require_dist(), 1);
var import_dist1889 = __toESM(require_dist2(), 1);
var import_dist1890 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/blob/sidecarsToVersionedHashes.js
var import_dist1891 = __toESM(require_dist(), 1);
var import_dist1892 = __toESM(require_dist2(), 1);
var import_dist1893 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/ens/toCoinType.js
var import_dist1894 = __toESM(require_dist(), 1);
var import_dist1895 = __toESM(require_dist2(), 1);
var import_dist1896 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/kzg/defineKzg.js
var import_dist1897 = __toESM(require_dist(), 1);
var import_dist1898 = __toESM(require_dist2(), 1);
var import_dist1899 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/kzg/setupKzg.js
var import_dist1900 = __toESM(require_dist(), 1);
var import_dist1901 = __toESM(require_dist2(), 1);
var import_dist1902 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/signature/compactSignatureToSignature.js
var import_dist1903 = __toESM(require_dist(), 1);
var import_dist1904 = __toESM(require_dist2(), 1);
var import_dist1905 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/signature/parseCompactSignature.js
var import_dist1906 = __toESM(require_dist(), 1);
var import_dist1907 = __toESM(require_dist2(), 1);
var import_dist1908 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/signature/parseSignature.js
var import_dist1909 = __toESM(require_dist(), 1);
var import_dist1910 = __toESM(require_dist2(), 1);
var import_dist1911 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/signature/recoverTransactionAddress.js
var import_dist1912 = __toESM(require_dist(), 1);
var import_dist1913 = __toESM(require_dist2(), 1);
var import_dist1914 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/signature/serializeCompactSignature.js
var import_dist1915 = __toESM(require_dist(), 1);
var import_dist1916 = __toESM(require_dist2(), 1);
var import_dist1917 = __toESM(require_dist3(), 1);

// node_modules/viem/_esm/utils/signature/signatureToCompactSignature.js
var import_dist1918 = __toESM(require_dist(), 1);
var import_dist1919 = __toESM(require_dist2(), 1);
var import_dist1920 = __toESM(require_dist3(), 1);
...
var import_dist1966 = __toESM(require_dist());
var import_dist1967 = __toESM(require_dist2());
var import_dist1968 = __toESM(require_dist3());

// node_modules/@reown/appkit-controllers/dist/esm/src/controllers/OnRampController.js
var import_dist1939 = __toESM(require_dist(), 1);
var import_dist1940 = __toESM(require_dist2(), 1);
var import_dist1941 = __toESM(require_dist3(), 1);
...
var import_dist1948 = __toESM(require_dist(), 1);
var import_dist1949 = __toESM(require_dist2(), 1);
var import_dist1950 = __toESM(require_dist3(), 1);

// node_modules/@reown/appkit-controllers/dist/esm/src/utils/SwapApiUtil.js
var import_dist1942 = __toESM(require_dist(), 1);
var import_dist1943 = __toESM(require_dist2(), 1);
var import_dist1944 = __toESM(require_dist3(), 1);

// node_modules/@reown/appkit-controllers/dist/esm/src/utils/SwapCalculationUtil.js
var import_dist1945 = __toESM(require_dist(), 1);
var import_dist1946 = __toESM(require_dist2(), 1);
var import_dist1947 = __toESM(require_dist3(), 1);
...
var import_dist1951 = __toESM(require_dist(), 1);
var import_dist1952 = __toESM(require_dist2(), 1);
var import_dist1953 = __toESM(require_dist3(), 1);
var state21 = proxy({
  message: "",
  open: false,
  triggerRect: {
...
var import_dist1957 = __toESM(require_dist(), 1);
var import_dist1958 = __toESM(require_dist2(), 1);
var import_dist1959 = __toESM(require_dist3(), 1);

// node_modules/@reown/appkit-controllers/dist/esm/src/utils/EnsUtil.js
var import_dist1954 = __toESM(require_dist(), 1);
var import_dist1955 = __toESM(require_dist2(), 1);
var import_dist1956 = __toESM(require_dist3(), 1);
...
var import_dist1960 = __toESM(require_dist(), 1);
var import_dist1961 = __toESM(require_dist2(), 1);
var import_dist1962 = __toESM(require_dist3(), 1);
var state23 = proxy({
  isLegalCheckboxChecked: false
});

// node_modules/@reown/appkit-controllers/dist/esm/src/utils/RouterUtil.js
var import_dist1963 = __toESM(require_dist(), 1);
var import_dist1964 = __toESM(require_dist2(), 1);
var import_dist1965 = __toESM(require_dist3(), 1);

// node_modules/@reown/appkit-ui/dist/esm/src/utils/ThemeUtil.js
var import_dist1969 = __toESM(require_dist(), 1);
var import_dist1970 = __toESM(require_dist2(), 1);
var import_dist1971 = __toESM(require_dist3(), 1);
var themeTag = void 0;
...
var import_dist1972 = __toESM(require_dist(), 1);
var import_dist1973 = __toESM(require_dist2(), 1);
var import_dist1974 = __toESM(require_dist3(), 1);
var UiHelperUtil = {
...
var import_dist1975 = __toESM(require_dist(), 1);
var import_dist1976 = __toESM(require_dist2(), 1);
var import_dist1977 = __toESM(require_dist3(), 1);
...
var import_dist1984 = __toESM(require_dist());
var import_dist1985 = __toESM(require_dist2());
var import_dist1986 = __toESM(require_dist3());

// node_modules/@reown/appkit-ui/dist/esm/src/utils/MathUtil.js
var import_dist1978 = __toESM(require_dist(), 1);
var import_dist1979 = __toESM(require_dist2(), 1);
var import_dist1980 = __toESM(require_dist3(), 1);

// node_modules/@reown/appkit-ui/dist/esm/src/utils/TransactionUtil.js
var import_dist1981 = __toESM(require_dist(), 1);
var import_dist1982 = __toESM(require_dist2(), 1);
var import_dist1983 = __toESM(require_dist3(), 1);

// node_modules/@reown/appkit-scaffold-ui/dist/esm/src/utils/ConstantsUtil.js
var import_dist1987 = __toESM(require_dist(), 1);
var import_dist1988 = __toESM(require_dist2(), 1);
var import_dist1989 = __toESM(require_dist3(), 1);
var ConstantsUtil3 = {
...
export {
  ...
  extendSchema,
  keccak2564 as keccak256,
  sha2567 as sha2562,
  validate6 as validate,
  toHex4 as toHex,
  assert3 as assert,
  checksum4 as checksum,
  fromPublicKey,
  isEqual,
  validate7 as validate2,
  encode9 as encode,
  from12 as from,
  toHex5 as toHex2,
  fromHex5 as fromHex,
  ...
  fromRpcList,
  toRpcList,
  recoverAddress3 as recoverAddress,
  recoverPublicKey3 as recoverPublicKey,
  verify,
  verifyHash4 as verifyHash,
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-QFWVLP5U.js.map
