...
var ICONS = {
  add: async () => (await import("./add-5GFFY5E6.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-Z3CUDNDM.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-TUSYELSH.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-VV2J2OVO.js")).appStoreSvg,
  apple: async () => (await import("./apple-W2AG4GVP.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-4CK3FC3Z.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-AWIUUITH.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-CSU2IXYL.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-HAMRTIS7.js")).arrowTopSvg,
  bank: async () => (await import("./bank-EVC7Q5SG.js")).bankSvg,
  browser: async () => (await import("./browser-4WL2ZGDY.js")).browserSvg,
  card: async () => (await import("./card-PFGWCFU5.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-JBHWCV7N.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-3D3DTCO5.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-5STT5QPE.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-QGZ4RPOI.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-EXH77PHG.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-B36UQHXA.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-3CKWE4QI.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-4LU2XFYU.js")).clockSvg,
  close: async () => (await import("./close-4NFLN4VQ.js")).closeSvg,
  compass: async () => (await import("./compass-3NQNZNDH.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-FUFO322U.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-NGGHV7N4.js")).copySvg,
  cursor: async () => (await import("./cursor-JE7E4GYO.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-C6WU3G5T.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-7Z3IEX63.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-4LJHFT5J.js")).disconnectSvg,
  discord: async () => (await import("./discord-WKWI6YQG.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-BUU4BANQ.js")).etherscanSvg,
  extension: async () => (await import("./extension-ZSKSY2P2.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-ZTWLN2UE.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-HQJDDI7T.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-YQ53RLQS.js")).farcasterSvg,
  filters: async () => (await import("./filters-5QG5OHHO.js")).filtersSvg,
  github: async () => (await import("./github-JSDAAPUS.js")).githubSvg,
  google: async () => (await import("./google-7JOPS37A.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-6NXGKWWN.js")).helpCircleSvg,
  image: async () => (await import("./image-KOXEIQHI.js")).imageSvg,
  id: async () => (await import("./id-Q2UFTNVH.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-54424DD4.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-TM5RGEYL.js")).lightbulbSvg,
  mail: async () => (await import("./mail-PZLIZDUW.js")).mailSvg,
  mobile: async () => (await import("./mobile-VLIEPQOG.js")).mobileSvg,
  more: async () => (await import("./more-V22BFTD4.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-KLMWCFKI.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-ENK3KPPX.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-CJO7K6V5.js")).offSvg,
  playStore: async () => (await import("./play-store-KG7T3NKG.js")).playStoreSvg,
  plus: async () => (await import("./plus-IQDWYITI.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-DNNQO5B7.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-YWAAO5VN.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-5UMGJG5K.js")).refreshSvg,
  search: async () => (await import("./search-YMDCTMB5.js")).searchSvg,
  send: async () => (await import("./send-NURPYTHC.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-JDBMCCKK.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-7SY5S2OC.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-NB3L7WZR.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-H2CJ4C5I.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-HFJDTQTC.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-KPTAUYP3.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-US6WPQ5J.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-OZF67BPU.js")).twitchSvg,
  twitter: async () => (await import("./x-34OPYWSE.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-VZZECV2V.js")).twitterIconSvg,
  verify: async () => (await import("./verify-GQNYZW7K.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-3FI7HKQQ.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-56TG4B3D.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-ELEN5BXT.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-ELEN5BXT.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-ELEN5BXT.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-J7HBGV5G.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-4IXEAYAY.js")).warningCircleSvg,
  x: async () => (await import("./x-34OPYWSE.js")).xSvg,
  info: async () => (await import("./info-FWLCJ6PB.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-7AF7I7OE.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-UXHRMSBJ.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BMLG7T6F.js.map
