...
import {
  require_jsx_runtime
} from "./chunk-OOHYSON3.js";
import {
  require_react
} from "./chunk-IMYVXJV7.js";
import {
  __export,
  __require,
  __toESM,
...
function snapshotFromTarget(projection) {
  ...
  return {
    animationId: ((_a2 = projection.root) == null ? void 0 : _a2.animationId) ?? 0,
    measuredBox,
    layoutBox,
...
var LayoutAnimationBuilder = class {
  ...
  async start() {
    ...
    afterRecords.forEach(({ projection }) => {
      ...
      const resumeFromInstance = (_a2 = projection.resumeFrom) == null ? void 0 : _a2.instance;
...
function transformViewBoxPoint(svgRef) {
  return (point2) => {
    ...
    const viewBox = (_a2 = svg.viewBox) == null ? void 0 : _a2.baseVal;
...
function handoffOptimizedAppearAnimation(elementId, valueName, frame2) {
  ...
  function cancelAnimation() {
    var _a3;
    (_a3 = window.MotionCancelOptimisedAnimation) == null ? void 0 : _a3.call(window, elementId, valueName, frame2);
  }
  animation.onfinish = cancelAnimation;
  if (startTime === null || ((_a2 = window.MotionHandoffIsComplete) == null ? void 0 : _a2.call(window, elementId))) {
    cancelAnimation();
    return null;
  } else {
    return startTime;
...
function startOptimizedAppearAnimation(element, name, keyframes2, options, onReady) {
  ...
  if (!readyAnimation) {
    ...
    window.MotionCheckAppearSync = (visualElement, valueName, value) => {
      ...
      if (!appearId)
        return;
      const valueIsOptimised = (_a2 = window.MotionHasOptimisedAnimation) == null ? void 0 : _a2.call(window, appearId, valueName);
      ...
      const removeSyncCheck = value.on("change", (latestValue) => {
        ...
        if (externalAnimationValue.get() !== latestValue) {
          (_a3 = window.MotionCancelOptimisedAnimation) == null ? void 0 : _a3.call(window, appearId, valueName);
          removeSyncCheck();
        }
      });
